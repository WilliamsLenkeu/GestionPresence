<nav class="navbar navbar-expand-lg text-bg-dark navbar-dark">
    <div class="container-fluid">
        <a class="navbar-brand m-auto" href="#">GestPresence</a>
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav pt-1 me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="#">Dashboard</a>
                </li>
                <li class="nav-item"><a class="nav-link" href="#">Liste d'Appels</a></li>
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a class="dropdown-item m-auto" href="#">
                                <svg class="m-auto" xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" class="bi bi-person-vcard-fill" viewBox="0 0 16 16">
